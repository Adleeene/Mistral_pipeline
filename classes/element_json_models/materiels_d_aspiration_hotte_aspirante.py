...
class materiels_d_aspiration_hotte_aspirante_0(BaseModel):
    ...
    date_de_mise_en_service : Optional[str] = Field(description="La date de mise en service de la hotte aspirante, si présent.")
    date_de_fabrication : Optional[str] = Field(description="La date de fabrication (peut être appelé plaque) de la hotte aspirante, si présent.")
    numero_de_fabrication : Optional[str] = Field(description="Le numéro de fabrication de la hotte aspirante, si présent.")

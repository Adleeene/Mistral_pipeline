...
class pmii_fosses_humides_0(BaseModel):
    type_de_control : Optional[Literal['Visite de surveillance', 'Visite de surveillance intermediaire en service']] = Field(description="Le type de contrôle effectué sur l'élément, si présent.")
    categorie_de_l_ouvrage : Optional[Literal['Catégorie 1', 'Catégorie 2', '']] = Field(description="La catégorie de l'ouvrage, si présent.")
    date_de_fabrication : Optional[str] = Field(description="La date de fabrication (peut être appelé plaque) de la fosse humide, si présent.")
    date_de_mise_en_service : Optional[str] = Field(description="La date de mise en service de la fosse humide, si présent.")
    ...
    nature_de_l_etancheite : Optional[Literal['Béton', 'Membrane', 'Revêtement superficiel', 'Autre', '']] = Field(description="La nature de l'étanchéité de la fosse humide, si présent.")
    longueur_m_var : Optional[float] = Field(description="La longueur en m de la fosse humide, si présent.")
    hauteur_m_var : Optional[float] = Field(description="La hauteur en m de la fosse humide, si présent.")
    en_location : Optional[bool] = Field(description=".")
    status : Optional[Literal['Actif', 'Au chômage', 'Au rebut', 'En stock', 'Au brouillon', '']] = Field(description="Le statut de la fosse humide, si présent.")

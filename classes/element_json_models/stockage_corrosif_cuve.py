...
class stockage_corrosif_cuve_0(BaseModel):
    ...
    date_d_essai_hydraulique : Optional[str] = Field(description="La date d'essai hydraulique de la cuve, si présent.")
    date_de_mise_en_service : Optional[str] = Field(description="La date de mise en service de la cuve, si présent.")
    date_de_fabrication : Optional[str] = Field(description="La date de fabrication (peut être appelé plaque) de la cuve, si présent.")
...
class stockage_corrosif_cuve_1(BaseModel):
    ...
    volume_m3_var : Optional[float] = Field(description="Le volume en mètre cube, si présent.")
...
class stockage_corrosif_cuve_2(BaseModel):
    ...
    phrases_de_risque_mentions_de_dangers : Optional[Literal['Rien', '']] = Field(description="Les phrases de risque et mentions de danger du produit stocké dans la cuve, si présent.")

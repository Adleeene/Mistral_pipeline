...
class materiels_d_aspiration_sorbonne_de_laboratoire_0(BaseModel):
    ...
    date_de_mise_en_service : Optional[str] = Field(description="La date de mise en service de la sorbonne de laboratoire, si présent.")
    date_de_fabrication : Optional[str] = Field(description="La date de fabrication (peut être appelé plaque) de la sorbonne de laboratoire, si présent.")
    fabricant : Optional[str] = Field(description="La marque du fabricant de la sorbonne de laboratoire, si présent.")
...
class materiels_d_aspiration_sorbonne_de_laboratoire_1(BaseModel):
    ...
    debit_d_air_neuf_introduit_dans_les_locaux_m3_h_var : Optional[str] = Field(description="Le débit d'air neuf introduit dans les locaux en m3/h, si présent.")
